...
const I18N = {
  ru: {
    ...
    tgVerifyDesc: "Перед отправкой запустите нашего Telegram-бота. Не нужно ждать ответа или одобрения — просто нажмите Start и подавайте заявку:",
    tgVerifyBtn: "Запустить бота в Telegram",
    tgVerifyStep1: "Нажмите кнопку и запустите бота (/start)",
    tgVerifyStep2: "Подавайте заполненную заявку на медиа",
    tgStatusIdle: "Ожидание ввода Telegram...",
    tgStatusChecking: "Проверка диалога с ботом...",
    tgStatusOk: "Telegram подтверждён — можно отправлять заявку",
    tgStatusErr: "Диалог с ботом не найден — сначала запустите бота!",
  ...
  ua: {
    ...
    tgVerifyDesc: "Перед відправкою запустіть нашого Telegram-бота. Не потрібно чекати на відповідь або схвалення — просто натисніть Start та подавайте заявку:",
    tgVerifyBtn: "Запустити бота в Telegram",
    tgVerifyStep1: "Натисніть кнопку та запустіть бота (/start)",
    tgVerifyStep2: "Подавайте заповнену заявку на медіа",
    tgStatusIdle: "Очікування введення Telegram...",
    tgStatusChecking: "Перевірка діалогу з ботом...",
    tgStatusOk: "Telegram підтверджено — можна надсилати заявку",
    tgStatusErr: "Діалог з ботом не знайдено — спочатку запустіть бота!",
  ...
  en: {
    ...
    tgVerifyDesc: "Before submitting, start our Telegram bot. No need to wait for a reply or approval — just press Start and submit your application:",
    tgVerifyBtn: "Start Telegram Bot",
    tgVerifyStep1: "Tap the button and start the bot (/start)",
    tgVerifyStep2: "Submit your completed media application",
    tgStatusIdle: "Waiting for Telegram handle...",
    tgStatusChecking: "Checking bot chat...",
    tgStatusOk: "Telegram verified — ready to submit application",
    tgStatusErr: "Bot chat not found — please start the bot first!",
