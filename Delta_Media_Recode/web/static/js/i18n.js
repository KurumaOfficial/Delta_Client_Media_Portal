...
const I18N = {
  ru: {
    ...
    tabLot: "🏷️ Заявка на лот",
    tabSub: "📺 Запрос подписки",
    tabMy: "📋 Мои заявки",
    tabAdmin: "🛡️ Админ-панель",
  ...
  ua: {
    ...
    heroDesc: "Заповни заявку — куратор розгляне її та відповість у Telegram. Контроль, швидкість та підтримка — все вже всередині.",
  ...
  en: {
    ...
    tabLot: "🏷️ Lot Request",
    tabSub: "📺 Subscription Request",
    tabMy: "📋 My Requests",
    tabAdmin: "🛡️ Admin Panel",
